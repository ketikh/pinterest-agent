...
def _video_config() -> dict:
    ...
    return {
        # Confirmed-working kie.ai model id. ("bytedance/seedance-1.0-lite" was
        # NOT a valid id and made Seedance reject the task.) Override via
        # KIE_VIDEO_MODEL once a valid cheaper id is known.
